...
@pytest.mark.usefixtures("window")
def test_f4_toggles_condition_panel(monkeypatch, window: arcade.Window | None) -> None:
    """F4 should toggle the condition debugger panel visibility."""
    monkeypatch.setenv("ARCADEACTIONS_VISUALIZER", "1")
    ...
    try:
        ...
        # Initial state
        initial_state = session.control_manager.condition_panel_visible
