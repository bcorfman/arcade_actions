...
def _maybe_auto_attach_visualizer() -> None:
    ...
    if os.getenv("ARCADEACTIONS_VISUALIZER"):
        # Importing visualizer triggers the auto-attach logic in arcadeactions.visualizer.__init__
...
def __getattr__(name: str):
    ...
    raise AttributeError(f"module 'arcadeactions' has no attribute '{name}'")
