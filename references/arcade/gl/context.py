...
class Context:
    ...
    def buffer(self, *, data: BufferProtocol | None = None, reserve: int = 0, usage: str = "static") -> Buffer:
        """
        ...
        *,
        ...
        Args:
            ...
            depth_attachment:
                Depth texture
        """
        return Framebuffer(self, color_attachments=color_attachments or [], depth_attachment=depth_attachment)
    ...
    def depth_texture(self, size: tuple[int, int], *, data: BufferProtocol | None = None) -> Texture2D:
        """
    ...
    def program(
        ...
        *,
        ...
        source_fs = ShaderSource(self, fragment_shader, common, gl.GL_FRAGMENT_SHADER) if fragment_shader else None
        source_geo = ShaderSource(self, geometry_shader, common, gl.GL_GEOMETRY_SHADER) if geometry_shader else None
        source_tc = (
            ShaderSource(self, tess_control_shader, common, gl.GL_TESS_CONTROL_SHADER) if tess_control_shader else None
        )
        source_te = (
