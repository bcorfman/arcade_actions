...
class VertexArray:
    ...
    def _build(self, program: Program, content: Sequence[BufferDescription], index_buffer: Buffer | None) -> None:
        """
    ...
    def render(self, mode: GLenumLike, first: int = 0, vertices: int = 0, instances: int = 1) -> None:
        """
