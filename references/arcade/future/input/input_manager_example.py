...
class Game(arcade.Window):
    def __init__(
        ...
        self.key_to_player_index: dict[Keys, int] = {getattr(Keys, f"KEY_{i + 1 }"): i for i in range(0, max_players)}
    ...
    def on_update(self, delta_time: float):
        ...
        for label, player in zip(self.player_device_labels, self.players, strict=False):
