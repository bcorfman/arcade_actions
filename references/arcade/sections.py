...
class SectionManager:
    ...
    def enable(self) -> None:
        ...
        """
        section_handlers = {event_type: getattr(self, event_type, None) for event_type in self.managed_events}
        if section_handlers:
    ...
    def dispatch_mouse_enter_leave_events(self, event_origin: str, x: int, y: int, *args, **kwargs) -> bool | None:
        """
