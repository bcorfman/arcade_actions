...
# Boxes
from arcade.types.box import LRBTNF, XYZWHD, Box

# Generic color aliases
# Specific color aliases
# The Color helper type
from arcade.types.color import (
    RGB,
    RGB255,
    RGBA,
    RGBA255,
...
# Rectangles
from arcade.types.rect import LBWH, LRBT, XYRR, XYWH, Rect, RectKwargs, RectParams, Viewport, ViewportParams

# Vector-like items and collections
from arcade.types.vector_like import (
    EMPTY_POINT_LIST,
    AnchorPoint,
    Point,
    Point2,
