...
class Clock:
    ...
    *Coming post 3.0:*
    ...
    def __init__(self, initial_elapsed: float = 0.0, initial_tick: int = 0, tick_speed: float = 1.0):
    ...
    def set_tick_speed(self, new_tick_speed: float):
        ...
        Args:
            new_tick_speed: A multiplier on the 'speed' of time.
                i.e. a value of 0.5 means time elapsed half as fast for this clock
        """
        raise ValueError("It is not safe to change the tick speed of a fixed clock post initialization.")
