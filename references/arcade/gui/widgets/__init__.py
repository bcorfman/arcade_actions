...
from typing import TYPE_CHECKING, Dict, List, NamedTuple, Optional, Self, Tuple, TypeVar, Union
...
class UIWidget(EventDispatcher, ABC):
    ...
    * A :class:`UIWidget` is not a :class:`~arcade.gui.UILayout`: it will not
    ...
    size_hint_min = Property[Optional[tuple[float | None, float | None]]](None)
    size_hint_max = Property[Optional[tuple[float | None, float | None]]](None)
