...
class PymunkPhysicsEngine:
    ...
    * :py:meth:`set_position`
    ...
    def __init__(self, gravity=(0, 0), damping: float = 1.0, maximum_incline_on_ground: float = 0.708) -> None:
        # -- Pymunk
    ...
    def get_sprites_from_arbiter(self, arbiter: pymunk.Arbiter) -> tuple[Sprite | None, Sprite | None]:
