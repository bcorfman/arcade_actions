...
class OrthographicProjectionData:
    ...
    def left(self, new_left: AsFloat):
        r = self.rect
        dl = new_left - r.left
        self.rect = Rect(new_left, r.right, r.bottom, r.top, r.width + dl, r.height, r.x + dl / 2.0, r.y)
    ...
    def right(self, new_right: AsFloat):
        ...
        self.rect = Rect(r.left, new_right, r.bottom, r.top, r.width + dr, r.height, r.x + dr / 2.0, r.y)
    ...
    def bottom(self, new_bottom: AsFloat):
        ...
        self.rect = Rect(r.left, r.right, new_bottom, r.top, r.width, r.height + db, r.x, r.y + db / 2.0)
    ...
    def top(self, new_top: AsFloat):
        r = self.rect
        dt = new_top - r.top
        self.rect = Rect(r.left, r.right, r.bottom, new_top, r.width, r.height + dt, r.x, r.y + dt / 2.0)
    ...
    def __str__(self):
        return f"OrthographicProjection<" f"LRBT={self.rect.lrbt}, " f"{self.near=}, " f"{self.far=}"
